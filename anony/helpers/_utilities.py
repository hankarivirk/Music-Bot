...
class Utilities:
    ...
    async def paste(self, text: str) -> str | None:
        """
        Uploads text to batbin.me and returns a shareable link, or None on failure.
        Used for content too large to comfortably show inside a Telegram message
        (e.g. big queues or playlists).
        """
        try:
            async with aiohttp.ClientSession() as session:
                async with session.post(
                    "https://batbin.me/documents",
